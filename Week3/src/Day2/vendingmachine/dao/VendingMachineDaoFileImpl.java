...
public class VendingMachineDaoFileImpl implements VendingMachineDao{
    ...
    public VendingMachineDaoFileImpl() {
        VENDING_MACHINE_FILE = "C:\\Users\\Ramon Lorente\\Desktop\\c184-Java-React\\Week3\\src\\Day2\\vendingmachine\\dao\\VendingMachineAuditFile";
    }
    ...
    //private Map<, Integer, VendingMachine> myVendingMachineProducts =new HashMap<>();
    ...
    public void checkProductAndUserMoney(int comparedMoney, VendingMachine userProduct, BigDecimal userMoney) throws VendingMachineInsufficientFundsException, VendingMachinePersistenceException {
        loadVendingMachine();
        if (comparedMoney >= 0) {
            if (userProduct != null) {
                ...
                myVendingMachineProducts.forEach((key, val) -> System.out.println(key + ", Total available = " + val + " units."));
            ...
            //ask user to insert money or main menu or quit
        }
        writeVendingMachine();
    }

    public BigDecimal updateUserMoneyAvailable(BigDecimal userMoney, VendingMachine userProduct) throws VendingMachinePersistenceException {
        loadVendingMachine();
    ...
    public void giveUserChangeInCoins(BigDecimal amount) throws VendingMachinePersistenceException {
        loadVendingMachine();
    ...
    public BigDecimal calculateUserAmountNeedItToPurchase(BigDecimal priceOfItem, BigDecimal userFounds ) throws VendingMachinePersistenceException {
        loadVendingMachine();
        BigDecimal totalToPutInMachine;
        return totalToPutInMachine = priceOfItem.subtract(userFounds);
    }

    public void printUserAmountNeedIt(BigDecimal priceOfItem, BigDecimal userFounds) throws VendingMachinePersistenceException {
        loadVendingMachine();
    ...
    private void loadVendingMachine() throws VendingMachinePersistenceException {
        ...
        while (scanner.hasNextLine()) {
            ...
            myVendingMachineProducts.put(currentVendingMachine, currentVendingMachine.getTotalUnits());
        }
        // close scanner
        scanner.close();
    }
