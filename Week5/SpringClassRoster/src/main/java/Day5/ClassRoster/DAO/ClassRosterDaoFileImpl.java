...
/*
 * The DAO’s only job is to store and retrieve Student information without altering that data in any way.
 */
...
public class ClassRosterDaoFileImpl implements ClassRosterDao {
    ...
    /**
     * This method gets all of the Student objects out of the students map as a collection by calling the values() method.
    ...
    /**
     * Ask the students map for the Student object with the given ID and return it
