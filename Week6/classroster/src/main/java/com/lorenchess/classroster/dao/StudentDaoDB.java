...
public class StudentDaoDB implements StudentDao{
    ...
    /**
     * We'll make the method @Transactional because we are running multiple queries that modify
     ...
     * Order matters here because we can't delete something that is being referenced by another
     * table.
     * */
